...
const licenseExplanations = [
  `When you embed charts or dashboards from Metabase in your own application, that application isn't subject to the Affero General Public License that covers the rest of Taric, provided you keep the Taric logo and the "Powered by Taric" visible on those embeds.`,
